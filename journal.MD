...
NOTE: for some reason images arent working right now, I will update my repo later with images of the pcbs, all my files are in though
...
for some reason I cannot paste the image, so I will be putting images in their respective files.
